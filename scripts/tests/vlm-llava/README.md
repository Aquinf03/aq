...
```
./aq/bin/aq train scripts/tests/vlm-llava
./aq/bin/aq eval scripts/tests/vlm-llava
cat scripts/tests/vlm-llava/artifacts/inspect.md
```
...
```
cd scripts/tests/vlm-llava && ../../../aq/bin/aq
```
...
aq = Aquin("scripts/tests/vlm-llava")
print(aq.train())
print(aq.eval())
print(aq.status())
PY
