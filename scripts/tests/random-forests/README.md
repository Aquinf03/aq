...
```
cd scripts/tests/random-forests
aq train
aq eval
...
```
aq ask scripts/tests/random-forests -y "Train the forest, then aq eval. Report mse and pass/fail. Read inspect.md."
```
...
aq = Aquin("scripts/tests/random-forests")
print(aq.train())
print(aq.eval())
print(aq.status())
PY
