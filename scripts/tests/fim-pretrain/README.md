...
```
aq ask scripts/tests/fim-pretrain -y "Train, then aq eval. Report pass/fail. Read inspect.md. objective, fim_order, causal?"
```
...
aq = Aquin("scripts/tests/fim-pretrain")
print(aq.train())
print(aq.eval())
print(aq.status())
PY
