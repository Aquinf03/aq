...
```
cd scripts/tests/decision-trees
aq train
aq eval
...
```
aq ask scripts/tests/decision-trees -y "Train the tree, then aq eval. Report mse and pass/fail. Read inspect.md."
```
...
aq = Aquin("scripts/tests/decision-trees")
print(aq.train())
print(aq.eval())
print(aq.status())
PY
