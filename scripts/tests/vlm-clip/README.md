...
```
./aq/bin/aq train scripts/tests/vlm-clip
./aq/bin/aq eval scripts/tests/vlm-clip
cat scripts/tests/vlm-clip/artifacts/inspect.md
```
...
```
cd scripts/tests/vlm-clip && ../../../aq/bin/aq
```
...
aq = Aquin("scripts/tests/vlm-clip")
print(aq.train())
print(aq.eval())
print(aq.status())
PY
