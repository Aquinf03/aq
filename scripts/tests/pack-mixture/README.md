...
```
aq ask scripts/tests/pack-mixture -y "Train, then aq eval. Report pass/fail. Read inspect.md. context, pack, mixture, packed_tokens?"
```
...
aq = Aquin("scripts/tests/pack-mixture")
print(aq.train())
print(aq.eval())
print(aq.status())
PY
