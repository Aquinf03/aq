...
| Surface | How |
|---------|-----|
| **CLI** | `./aq/bin/aq train scripts/tests/<path>` |
...
cd scripts/tests/sdk-ridge && ../../../aq/kernel/.venv/bin/python example.py
```
...
Other suites are science fixtures (CLI + optional `Aquin("scripts/tests/…")`). Canonical SDK samples are the three folders above.
