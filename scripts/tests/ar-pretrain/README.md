...
```
aq ask scripts/tests/ar-pretrain -y "Train, then aq eval. Report pass/fail. Read inspect.md. objective, causal, n_pred?"
```
...
aq = Aquin("scripts/tests/ar-pretrain")
print(aq.train())
print(aq.eval())
print(aq.status())
PY
