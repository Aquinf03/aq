...
```
aq ask scripts/tests/lora/tune -y "Train, then aq eval. Report pass/fail. Read inspect.md. objective, rank, frozen, parent?"
```
...
aq = Aquin("scripts/tests/lora/base")
print(aq.train())
print(aq.eval())
aq = Aquin("scripts/tests/lora/tune")
print(aq.train())
print(aq.eval())
print(aq.status())
PY
