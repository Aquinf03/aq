...
```
aq ask scripts/tests/full-ft/tune -y "Train, then aq eval. Report pass/fail. Read inspect.md. objective, loss_on, parent?"
```
...
aq = Aquin("scripts/tests/full-ft/base")
print(aq.train())
print(aq.eval())
aq = Aquin("scripts/tests/full-ft/tune")
print(aq.train())
print(aq.eval())
print(aq.status())
PY
