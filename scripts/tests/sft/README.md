...
```
aq ask scripts/tests/sft/tune -y "Train, then aq eval. Report pass/fail. Read inspect.md. objective, loss_on, parent?"
```
...
aq = Aquin("scripts/tests/sft/base")
print(aq.train())
print(aq.eval())
aq = Aquin("scripts/tests/sft/tune")
print(aq.train())
print(aq.eval())
print(aq.status())
PY
