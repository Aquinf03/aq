...
```
cd scripts/tests/transformers/decoder
aq train
aq eval
...
```
cd scripts/tests/transformers/encoder
aq train
aq eval
cat artifacts/inspect.md
```
...
```
cd scripts/tests/transformers/encoder-decoder
aq train
aq eval
cat artifacts/inspect.md
```
...
```
aq ask scripts/tests/transformers/decoder -y "Train the transformer, then aq eval. Report loss and pass/fail. Read inspect.md. What arch?"
```
...
aq = Aquin("scripts/tests/transformers/decoder")
print(aq.train())
print(aq.eval())
aq = Aquin("scripts/tests/transformers/encoder")
print(aq.train())
print(aq.eval())
aq = Aquin("scripts/tests/transformers/encoder-decoder")
print(aq.train())
print(aq.eval())
print(aq.status())
PY
