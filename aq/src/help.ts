...
export function help(): string {
  return [
    ...
    "  aq launch [dir] --on <place> [--no-setup] [--port N] [-- <cmd>]",
    "                          sync folder → place, setup aq, open SSH",
    "  aq go [place] [--port N]  re-SSH to last launch (resync if local folder)",
    ...
    "  aq jobs run|train|eval|serve [--on p] [--nodes N] [--gpu N] [--port N] [--json]",
