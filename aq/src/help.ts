...
export function help(): string {
  return [
    ...
    "  aq train [dir] [--tracker] [--system] [--capture-code] [--capture-env[=lock|full]]",
    "                          --system → CPU/GPU/mem/disk/net beside loss (metrics + TUI)",
    "                          --capture-code → artifacts/code/tree.tgz",
    "                          --capture-env → artifacts/env/ (lock=pip freeze; full=7z venv)",
    "                          recipe capture.system / capture.code / capture.env · AQ_CAPTURE_*",
