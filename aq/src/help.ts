...
export function help(): string {
  return [
    ...
    "  aq fork <new-dir>      copy this run; skip jobs/ and artifacts/",
    "  aq fork <src> <dest>   copy that run to dest",
    ...
    "  aq job plan [dir] | tick | run <name>  cron/sweep/pipeline plans (recipe.yaml)",
    "  aq schedule …                 alias for aq job plan …",
    "  aq stage [dir] | init <name> | <name> | eval <name>  nested runs",
    ...
    "",
    "init writes:",
    "  recipe.yaml     paths (data, eval, …) live here",
    "  example.py      aquin SDK sample",
