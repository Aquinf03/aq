...
/** Pill tabs in the titlebar (browser-like). Scrolls horizontally when tight. */
export function WorkspaceTabBar({
  ...
  return (
    <div className="aquin-no-drag flex h-full min-w-0 flex-1 items-end gap-1 overflow-x-auto overflow-y-hidden px-0.5 pb-1.5 pt-0.5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:gap-1.5">
      {tabs.map(tab => {
